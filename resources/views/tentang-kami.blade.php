...
@section('content')
            ...
            <div class="text-center text-white px-3 sm:px-4 max-w-6xl mx-auto">
                ...
                <div class="flex flex-col items-center">
                    <button onclick="scrollToContent()"
                        class="group relative animate-bounce cursor-pointer p-2 sm:p-4 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
    ...
    <section id="tentang-kami" class="py-12 sm:py-16 lg:py-24 bg-gradient-to-b from-white to-blue-50">
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div class="flex justify-center lg:justify-start order-1 lg:order-1">
                    <div
                        class="w-60 h-60 sm:w-80 sm:h-80 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 p-4 sm:p-8 flex items-center justify-center border-2 border-blue-100">
                ...
                <div class="p-4 sm:p-8 order-2 lg:order-2">
                    <div class="space-y-4 sm:space-y-6 text-gray-700 font-nunito">
                        <p class="text-sm sm:text-lg leading-relaxed">
                            ...
                            makanan lain selain ASI untuk memenuhi kebutuhan nutrisi hariannya.
                        </p>
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-3 sm:p-4 rounded-r-lg">
                            <p class="text-sm sm:text-lg leading-relaxed font-medium text-blue-800">
    ...
    <section class="py-12 sm:py-16 bg-gray-50">
        <div class="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl text-[#6C63FF] mb-4 sm:mb-8 font-fredoka">
                    Kebanggaan Kami
                </h2>
                <p class="font-nunito text-sm sm:text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto px-2 sm:px-0">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
                ...
                <div
                    ...
                    <div class="relative p-4 sm:p-8">
                        <div
                            class="absolute top-2 sm:top-4 right-2 sm:right-4 bg-blue-500 text-white px-2 sm:px-3 py-1 rounded-full text-xs font-medium">
                            Terpercaya
                        </div>
                        <div class="text-center">
                            <div class="text-3xl sm:text-4xl lg:text-5xl text-blue-600 mb-2 sm:mb-3 font-fredoka font-bold">
                                10,000+
                            </div>
                            <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 font-nunito">
                                Keluarga Terlayani
                            </h3>
                            <p class="text-xs sm:text-sm text-gray-600 font-nunito leading-relaxed">
                ...
                <div
                    ...
                    <div class="p-4 sm:p-8">
                        <div class="text-center">
                            <div
                                class="text-3xl sm:text-4xl lg:text-5xl text-orange-600 mb-2 sm:mb-3 font-fredoka font-bold">
                                50+
                            </div>
                            <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 font-nunito">
                                Varian Produk MPASI
                ...
                <!-- Stat 3: Bahan Alami -->
                <div
                    class="bg-white rounded-xl border-2 border-gray-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden sm:col-span-2 lg:col-span-1">
                    <div class="p-4 sm:p-8">
                        <div class="text-center">
                            <div
                                class="text-3xl sm:text-4xl lg:text-5xl text-green-600 mb-2 sm:mb-3 font-fredoka font-bold">
                                100%
                            </div>
                            <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-1 sm:mb-2 font-nunito">
                                Bahan Alami & Aman
    ...
    <section class="py-12 sm:py-16 bg-gray-50">
        <div class="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <div class="prose prose-lg max-w-none text-gray-700 font-nunito">
                <p class="text-sm sm:text-lg leading-relaxed mb-4 sm:mb-6">
                ...
                <p class="text-sm sm:text-lg leading-relaxed mb-6 sm:mb-8">
        ...
        <div class="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
                ...
                <div class="text-center lg:text-left">
                    <h2 class="text-2xl sm:text-3xl lg:text-4xl text-[#6C63FF] mb-6 sm:mb-8 font-fredoka">
                        Visi
                    </h2>
                    <div class="space-y-3 sm:space-y-4 font-nunito">
                        <p class="text-sm sm:text-lg text-gray-700 mb-4 sm:mb-6">
                        ...
                        <ul class="space-y-2 sm:space-y-3 text-gray-700">
                            <li class="flex items-start">
                                <div class="rounded-full bg-green-100 p-1 flex-shrink-0 mr-4">
                                ...
                                <span class="text-xs sm:text-base">Menghadirkan MPASI berkualitas tinggi dengan standar
                                    internasional</span>
                            </li>
                            <li class="flex items-start">
                                <div class="rounded-full bg-green-100 p-1 flex-shrink-0 mr-4">
                                ...
                                <span class="text-xs sm:text-base">Mendukung ibu Indonesia dalam memberikan nutrisi
                                    terbaik</span>
                            </li>
                            <li class="flex items-start">
                                <div class="rounded-full bg-green-100 p-1 flex-shrink-0 mr-4">
                                ...
                                <span class="text-xs sm:text-base">Menciptakan generasi Indonesia yang sehat dan
                                    cerdas</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="space-y-3 sm:space-y-4 font-nunito">
                        ...
                        <ul class="space-y-2 sm:space-y-3 text-gray-700">
                            <li class="flex items-start">
                                ...
                                <span class="text-xs sm:text-base">Menggunakan bahan organik dan berkualitas tinggi</span>
                            </li>
                            <li class="flex items-start">
                                <div class="rounded-full bg-green-100 p-1 flex-shrink-0 mr-4">
                                    <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span class="text-xs sm:text-base">Proses produksi higienis dengan standar keamanan
                                    pangan</span>
                            </li>
                            <li class="flex items-start">
                                <div class="rounded-full bg-green-100 p-1 flex-shrink-0 mr-4">
                                ...
                                <span class="text-xs sm:text-base">Memberikan edukasi MPASI yang tepat kepada
                                    orangtua</span>
                            </li>
                            <li class="flex items-start">
                                <div class="rounded-full bg-green-100 p-1 flex-shrink-0 mr-4">
                                ...
                                <span class="text-xs sm:text-base">Inovasi berkelanjutan dalam pengembangan produk
                                    MPASI</span>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="py-12 sm:py-16 bg-gray-50">
        <div class="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12">
                ...
                <p class="text-sm sm:text-lg text-gray-600 max-w-3xl mx-auto font-nunito px-2 sm:px-0">
            ...
            <div class="rounded-lg overflow-hidden">
                <img src="{{ asset('images/employees.jpg') }}" alt="Gentle Baby"
                    class="w-full h-48 sm:h-64 md:h-80 lg:h-auto object-cover transition-transform duration-300 hover:scale-110">
            </div>
