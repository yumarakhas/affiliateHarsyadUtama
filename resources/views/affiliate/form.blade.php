            ...
            <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-8">
                    <form action="{{ route('affiliate.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <input type="email" 
                                       ...
                                       name="email" 
                                       value="{{ old('email') }}"
                                       class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#528B89] focus:border-brand-500 transition-all duration-300 bg-white hover:border-gray-300 @error('email') border-red-400 @enderror"
                        ...
                        <!-- Nama Lengkap -->
                        <div class="mb-6">
                            <label for="nama_lengkap" class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
                                <svg class="w-4 h-4 mr-2 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#528B89] focus:border-brand-500 transition-all duration-300 bg-white hover:border-gray-300 @error('nama_lengkap') border-red-400 @enderror"
                        ...
                        <!-- Kontak WhatsApp -->
                        <div class="mb-6">
                            <label for="kontak_whatsapp" class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
                                <svg class="w-4 h-4 mr-2 text-brand-500" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#528B89] focus:border-brand-500 transition-all duration-300 bg-white hover:border-gray-300 @error('kontak_whatsapp') border-red-400 @enderror"
                                   placeholder="Contoh: 08123456786 (untuk dihubungi oleh admin)"
                                   required>
                        ...
                        <!-- Kota Domisili -->
                        <div class="mb-6">
                            <label for="kota_domisili" class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
                                <svg class="w-4 h-4 mr-2 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#528B89] focus:border-brand-500 transition-all duration-300 bg-white hover:border-gray-300 @error('kota_domisili') border-red-400 @enderror"
                        ...
                        <div class="mb-8">
                            <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-100">
                                ...
                                <!-- Akun Instagram -->
                                <div class="mb-6">
                                    <label for="akun_instagram" class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
                                ...
                                <!-- Akun TikTok -->
                                <div class="mb-4">
                                    <label for="akun_tiktok" class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
                        ...
                        <!-- Profesi/Kesibukan -->
                        <div class="mb-8">
                            <label for="profesi_kesibukan" class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
                                <svg class="w-4 h-4 mr-2 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <textarea id="profesi_kesibukan" 
                                      ...
                                      rows="4"
                                      class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#528B89] focus:border-brand-500 transition-all duration-300 bg-white hover:border-gray-300 resize-none @error('profesi_kesibukan') border-red-400 @enderror"
                        ...
                        <div class="mb-8">
                            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-100">
                                <label class="text-lg font-bold text-gray-700 mb-4 flex items-center">
                                ...
                                <label class="flex items-start cursor-pointer">
                                    ...
                                    <div class="ml-3">
                                        <span class="text-sm font-medium text-gray-700">
                                            Saya menyetujui untuk bergabung dalam program affiliate <strong class="text-green-700">Gentle Living</strong> dan <strong class="text-green-700">bersedia dihubungi oleh admin</strong> untuk keperluan verifikasi dan komunikasi terkait program affiliate.
                                        </span>
                                    </div>
                                </label>
                                @error('persetujuan')
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            const akunInstagram = document.getElementById('akun_instagram').value.trim();
