...
<div id="sidebar"
    ...
    <div class="flex items-center justify-between h-20 px-6 border-b border-gray-100">
        ...
        <div class="sidebar-logo flex items-center">
            <h2 class="sidebar-text text-xl font-bold text-brand-500" style="font-family: 'Nunito', sans-serif;">
                Admin Panel
            </h2>
        </div>
        ...
        <ul class="space-y-3">
            ...
            <li class="relative">
                <a href="{{ route('admin.view-data') }}"
                    class="nav-item group flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-gray-50 transition-all duration-200 {{ request()->routeIs('admin.view-data') ? 'active text-white' : '' }}">
            ...
            <li class="relative">
                <button onclick="toggleSubmenu('pengaturan')"
                    ...
                    <x-heroicon-s-chevron-down class="sidebar-text w-4 h-4 transition-transform duration-200"
                ...
                <ul id="pengaturan-submenu"
                    ...
                    <li>
                        <a href="{{ route('beranda') }}"
                            class="group flex items-center px-4 py-2 rounded-lg transition-all duration-200 {{ request()->routeIs('beranda') ? 'bg-brand-500 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-brand-500' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.products.index') }}"
                            class="group flex items-center px-4 py-2 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.products.*') ? 'bg-brand-500 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-brand-500' }}">
                    ...
                    <li>
                        <a href="{{ route('partner') }}"
                            class="group flex items-center px-4 py-2 rounded-lg transition-all duration-200 {{ request()->routeIs('partner') ? 'bg-brand-500 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-brand-500' }}">
                    ...
                    <li>
                        <a href="{{ route('tentang-kami') }}"
                            class="group flex items-center px-4 py-2 rounded-lg transition-all duration-200 {{ request()->routeIs('tentang-kami') ? 'bg-brand-500 text-white' : 'text-gray-600 hover:bg-gray-50 hover:text-brand-500' }}">
