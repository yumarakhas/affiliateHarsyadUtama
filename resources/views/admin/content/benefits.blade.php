...
<div class="p-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
            <div class="flex space-x-1 overflow-x-auto">
                ...
                <a href="{{ route('admin.content.carousel-produk') }}" 
                   class="flex items-center px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap text-gray-600 hover:text-blue-600 hover:bg-blue-50">
                ...
                <a href="{{ route('admin.content.benefits') }}" 
                   class="flex items-center px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 whitespace-nowrap bg-green-500 text-white shadow-md">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="text-center py-16">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Kelola Benefits</h3>
            <p class="text-gray-600 mb-6 max-w-md mx-auto">
                Fitur ini akan memungkinkan Anda untuk mengelola section manfaat dan keunggulan produk 
                di halaman beranda. Anda dapat menambah, mengedit, dan mengatur urutan benefits.
            </p>
