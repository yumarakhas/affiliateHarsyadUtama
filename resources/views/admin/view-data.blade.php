                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-8 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Tanggal Daftar</th>
                                <th
                                    class="px-8 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Aksi</th>
                            </tr>
                        </thead>
                            ...
                            @forelse($affiliates as $index => $affiliate)
                                <tr class="hover:bg-gray-50 transition-colors duration-200 affiliate-row"
                                    ...
                                    <td class="px-8 py-6">
                                        <div>
                                            <div class="text-sm font-semibold text-gray-900">
                                                {{ $affiliate->nama_lengkap ?? 'No Name' }}</div>
                                            <div class="text-sm text-gray-500 mt-1">{{ $affiliate->email ?? 'No Email' }}
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-6">
                                    ...
                                    <td class="px-8 py-6 whitespace-nowrap">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex px-3 py-2 text-xs font-semibold rounded-full {{ $statusClass }}">
                                            @if ($status === 'Pending')
                        ...
                        emptyMessage.innerHTML = `
                            <td colspan="7" class="px-8 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <button onclick="resetFilters()" class="px-4 py-2 bg-brand-500 text-white rounded-lg hover:bg-brand-600 transition-colors duration-200">
                                        Reset Filter
                                    </button>
                                </div>
                            </td>
