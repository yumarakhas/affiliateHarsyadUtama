                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <h1 style="font-family: 'Fredoka One', cursive;"
                                    class="text-2xl text-white flex items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-bold text-gray-900">
                                            {{ $affiliates->where('status', 'Aktif')->count() }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-red-50 rounded-lg p-4 border border-red-100">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-bold text-gray-900">
                                            {{ $affiliates->where('status', 'Tidak Aktif')->count() }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="space-y-1">
                                                    ...
                                                    @if ($affiliate->affiliateInfo && $affiliate->affiliateInfo->akun_tiktok)
                                                        <div class="text-sm text-gray-900 flex items-center">
                                                            <svg class="w-4 h-4 mr-1 text-black" fill="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path
                                                    ...
                                                    @if (
                                                        !$affiliate->affiliateInfo ||
                                                            (!$affiliate->affiliateInfo->akun_instagram && !$affiliate->affiliateInfo->akun_tiktok))
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center space-x-3">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <button
                                                        onclick="deleteAffiliate({{ $affiliate->id }}, '{{ $affiliate->nama_lengkap }}')"
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900">${affiliate.email}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-600">Nama Lengkap</label>
                                        <p class="text-sm text-gray-900">${affiliate.nama_lengkap}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-600">Kontak WhatsApp</label>
                                        <p class="text-sm text-gray-900">${affiliate.kontak_whatsapp}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-600">Kota Domisili</label>
                                        <p class="text-sm text-gray-900">${affiliate.kota_domisili}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900">${info.akun_instagram || '-'}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-600">TikTok</label>
                                        <p class="text-sm text-gray-900">${info.akun_tiktok || '-'}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900">${affiliate.profesi_kesibukan}</p>
                                    </div>
                                    <div>
                    ...
                    fetch(`/admin/affiliate/${affiliateId}/update-status`, {
                        ...
                        .then(data => {
                            ...
                            newStatus === 'Aktif' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                ...
                                const statusText = newStatus === 'Aktif' ? 'diaktifkan' :
                                    'dinonaktifkan';
                                Swal.fire({
                                    title: 'Berhasil!',
